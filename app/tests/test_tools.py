...
#    Test is actually ok but throws "IndexError: invalid index to scalar variable" because of the line "if value[2][0].isalpha() == True or value[2][-1].isalpha() == True:" on check_min_max().
    ...
    def test_check_generate_standard_values_pa(self):
        ...
        expected_values = {
            'ee_std':[Decimal(19.459), Decimal(58.8), Decimal(2.82)],
            'cp_std':[Decimal(7.185), Decimal(18), Decimal(60.433)],
            'cf_std':[Decimal(16.106), None, Decimal(8.669)],
            'ash_std':[Decimal(6.486), Decimal(2.4), Decimal(26.059)],
            'nfe_std':[Decimal(38.579), Decimal(20.8), Decimal(2.019)]
        }
