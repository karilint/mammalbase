...
#    Test is actually ok but throws "IndexError: invalid index to scalar variable" because of the line "if value[2][0].isalpha() == True or value[2][-1].isalpha() == True:" on check_min_max().
    ...
    def test_false_get_fooditem_json(self, m):
        m.get('https://www.itis.gov/ITISWebService/jsonservice/getITISTermsFromScientificName?srchKey=Voikukka',
    ...
    def test_invalid_get_fooditem_json(self, m):
        m.get('https://www.itis.gov/ITISWebService/jsonservice/getITISTermsFromScientificName?srchKey=Galipea%20officinalis',
        ...
        m.get('https://www.itis.gov/ITISWebService/jsonservice/getITISTermsFromScientificName?srchKey=Oxya%20japonica',
