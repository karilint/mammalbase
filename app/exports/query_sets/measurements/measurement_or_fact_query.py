...
def measurement_or_fact_query(measurement_choices, is_admin_or_contributor):
    """ 
        ...
        according to the user choices (measurement_choices in base_query). exports/tasks.py has a 
        function create_measurement_or_fact_query() to create the different files.
