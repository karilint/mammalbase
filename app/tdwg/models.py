...
class Taxon(models.Model):
    ...
    infrageneric_epithet = models.CharField(
            max_length=50,
            null=True,
            blank=True,
            help_text=(
                    "The infrageneric part of a binomial name"
                    " at ranks above species but below genus."))
    ...
    cultivar_epithet = models.CharField(
            max_length=50,
            null=True,
            blank=True,
            help_text=(
                    "Part of the name of a cultivar, cultivar group "
                    "or grex that follows the scientific name."))
    ...
    nomenclatural_code = models.CharField(
            ...
            blank=True,
            help_text=(
                    "The nomenclatural code under which "
                    "the scientificName is constructed."))
    ...
    accepted_name_usage = models.CharField(
            ...
            blank=True,
            help_text=(
                    "The name (scientificName or higherTaxon) currently "
                    "accepted as representing the same concept as the name."))
    ...
    name_according_to = models.CharField(
            ...
            blank=True,
            help_text=(
                    "A reference to the source in which the taxon name "
                    "is considered authoritative or correct."))
    nomenclatural_status = models.CharField(
            ...
            help_text=(
                    ...
                    "of the name and its conformance to the relevant rules "
                    "of nomenclature. It is based essentially "
                    "on an algorithm according to the business rules "
                    "of the code. It requires no taxonomic opinion."))
    name_published_in_year = models.IntegerField(
            null=True,
            blank=True,
    ...
    higher_classification = models.TextField(
            ...
            help_text=(
                    ...
                    "terminating at the rank immediately higher "
                    "than the taxon referenced in the taxon record."))
    # Add other fields specific to your use case
    nameAccordingToID = models.CharField(
            max_length=255,
            null=True,
            blank=True,
            help_text=(
                    "An identifier for the reference that supports "
                    "the taxon name in the nameAccordingTo field."))
    ...
    name_published_in_id = models.CharField(
            ...
            blank=True,
            help_text=(
                    "An identifier for the publication in which "
                    "the scientific name was established."))
