...
RECODE_OPENAI_PASS1_MAX_ITEMS_PER_BUCKET = int(environ.get('RECODE_OPENAI_PASS1_MAX_ITEMS_PER_BUCKET', 30))
RECODE_OPENAI_PASS1_MAX_ITEM_CHARS = int(environ.get('RECODE_OPENAI_PASS1_MAX_ITEM_CHARS', 1200))
