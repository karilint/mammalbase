...
from . import views
from matchtools.views import source_location_list
...
#    path('select2/', include('django_select2.urls')),
    ...
    path('ar/<int:sa>/new/', views.attribute_relation_new, name='attribute-relation-new'),
    path('csor/<int:cso>/new/', views.choiceset_option_relation_new, name='choiceset_option_relation-new'),
    path('csor/<int:pk>/', views.choiceset_option_relation_detail, name='choiceset_option_relation-detail'),
    path('csor/<int:pk>/delete/', views.choiceset_option_relation_delete.as_view(), name='choiceset_option_relation-delete'),
    path('csor/<int:pk>/edit/', views.choiceset_option_relation_edit, name='choiceset_option_relation-edit'),
    ...
    path('dsi/<int:pk>/edit/', views.diet_set_item_edit, name='diet_set_item-edit'),
    ...
    path('er/<int:pk>/delete/', views.entity_relation_delete.as_view(), name='entity_relation-delete'),
    path('er/<int:pk>/edit/', views.entity_relation_edit, name='entity_relation-edit'),
    path('fi/', views.food_item_list, name='food_item-list'),
...
#    path('import/ds', import_diet_set, name='diet_set-import'),
    ...
    path('ma/<int:pk>/edit/', views.master_attribute_edit, name='master_attribute-edit'),
    path('mac/<int:pk>/', views.master_choiceset_option_detail, name='master_choiceset_option-detail'),
    path('mac/<int:pk>/delete/', views.master_choiceset_option_delete.as_view(), name='master_choiceset_option-delete'),
    path('mac/<int:pk>/edit/', views.master_choiceset_option_edit, name='master_choiceset_option-edit'),
    path('mac/new/<int:master_attribute>/', views.master_attribute_master_choiceset_option_new, name='master_attribute_master_choiceset_option-new'),
    path('me/', views.master_entity_list, name='master_entity-list'),
    path('me/<int:pk>/', views.master_entity_detail, name='master_entity-detail'),
...
#    path('mr/', views.master_reference_list, name='master_reference-list'),
    ...
    path('pa/', views.proximate_analysis_list, name='proximate_analysis-list'),
    path('pa/<int:pk>/', views.proximate_analysis_detail, name='proximate_analysis-detail'),
    path('pa/<int:pk>/delete/', views.proximate_analysis_delete.as_view(), name='proximate_analysis-delete'),
    path('pa/<int:pk>/edit/', views.proximate_analysis_edit, name='proximate_analysis-edit'),
    path('pai/', views.proximate_analysis_item_list, name='proximate_analysis_item-list'),
    path('pai/<int:pk>/', views.proximate_analysis_item_detail, name='proximate_analysis_item-detail'),
    path('pai/<int:pk>/delete/', views.proximate_analysis_item_delete.as_view(), name='proximate_analysis_item-delete'),
    path('pai/<int:pk>/edit/', views.proximate_analysis_item_edit, name='proximate_analysis_item-edit'),
    ...
    path('sa/<int:pk>/edit/', views.source_attribute_edit, name='source_attribute-edit'),
    path('sac/<int:pk>/', views.source_choiceset_option_detail, name='source_choiceset_option-detail'),
    path('sac/<int:pk>/delete/', views.source_choiceset_option_delete.as_view(), name='source_choiceset_option-delete'),
    path('sac/<int:pk>/edit/', views.source_choiceset_option_edit, name='source_choiceset_option-edit'),
    path('sac/new/<int:source_attribute>/', views.source_attribute_source_choiceset_option_new, name='source_attribute_source_choiceset_option-new'),
    path('sav/<int:pk>/', views.source_choiceset_option_value_detail, name='source_choiceset_option_value-detail'),
    ...
    path('smv/<int:pk>/', views.source_measurement_value_detail, name='source_measurement_value-detail'),
    path('smv/<int:pk>/edit/', views.source_measurement_value_edit, name='source_measurement_value-edit'),
    path('smv/<int:pk>/delete/', views.source_measurement_value__delete.as_view(), name='source_measurement_value-delete'),
    path('smv/new/<int:sa>/<int:se>/', views.source_measurement_value_new, name='source-measurementvalue-new'),
    ...
    path('srattribute/new/<int:source_reference>/<int:type>/', views.source_reference_attribute_new, name='source_reference-attribute-new'),
    path('srattribute/new/<int:source_reference>/<int:source_entity>/', views.source_entity_attribute_new, name='source_entity-attribute-new'),
    path('srm/new/<int:source_reference>/<int:source_entity>/', views.source_entity_measurement_new, name='source_entity-measurement-new'),
    path('tp/', views.time_period_list, name='time_period-list'),
    path('tp/<int:pk>/', views.time_period_detail, name='time_period-detail'),
    path('tp/<int:pk>/delete/', views.time_period_delete.as_view(), name='time_period-delete'),
    path('tp/<int:pk>/edit/', views.time_period_edit, name='time_period-edit'),
    path('tsn/', views.tsn_list, name='tsn-list'),
    path('tsn/<int:tsn>/', views.tsn_detail, name='tsn-detail'),
    ...
    path('lm/', source_location_list, name='source-location-list')
]
