...
class Command(BaseCommand):
    ...
    def add_olson_biomes(self):
        olson_reference = self.importer.get_or_create_master_reference(citation="Olson, J S, Watts, J A, and Allison, L J. Carbon in live vegetation of major world ecosystems. United States: N. p., 1983. Web.", author=self.user)
