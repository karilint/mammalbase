# Generated by Django 3.2.25 on 2024-05-02 15:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match_attempts', models.IntegerField(default=0, help_text='The number of attempted matches for this location.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_on', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True, help_text='Is the record active')),
                ('name', models.CharField(help_text='Enter the Time Period', max_length=250)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_id', models.CharField(blank=True, help_text='Enter the locationID of the Master Location', max_length=250, null=True)),
                ('is_reserve', models.BooleanField(default=False, help_text='Is this location a nature/wildlife/forest reserve?')),
                ...
                ('country_code', models.CharField(blank=True, help_text='Enter the country code of the Master Location', max_length=10, null=True)),
                ('state_province', models.CharField(blank=True, help_text='Enter the state province of the Master Location', max_length=250, null=True)),
                ...
                ('minimum_elevation_in_meters', models.CharField(blank=True, help_text='Enter the minimum elevation in meters of the Master Location', max_length=250, null=True)),
                ('maximum_elevation_in_meters', models.CharField(blank=True, help_text='Enter the maximum elevation in meters of the Master Location', max_length=250, null=True)),
                ('location_according_to', models.CharField(blank=True, help_text='Enter the information about the source of this location information of the Master Location', max_length=250, null=True)),
                ('location_remarks', models.CharField(blank=True, help_text='Enter the location remarks of the Master Location', max_length=250, null=True)),
                ('decimal_latitude', models.CharField(blank=True, help_text='Enter the decimal latitude of the Master Location', max_length=250, null=True)),
                ('decimal_longitude', models.CharField(blank=True, help_text='Enter the decimal longitude of the Master Location', max_length=250, null=True)),
                ('geodetic_datum', models.CharField(blank=True, help_text='Enter the geodetic datum of the Master Location', max_length=250, null=True)),
                ...
                ('higher_geography', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mb.masterlocation')),
                ...
                ('reference', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mb.masterreference')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('created_by', django_userforeignkey.models.fields.UserForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='The user that is automatically assigned')),
                ('higher_geography', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='mb.masterlocation')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('modified_by', django_userforeignkey.models.fields.UserForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='The user that is automatically assigned')),
