# Generated by Django 3.2.23 on 2024-02-13 16:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eco_code', models.PositiveSmallIntegerField(blank=True, default=0, help_text='Eco code', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master_habitat', models.ManyToManyField(through='mb.HabitatRelation', to='mb.MasterHabitat')),
        ...
        migrations.AddField(
            model_name='masterhabitat',
            name='source_habitat',
            field=models.ManyToManyField(to='mb.SourceHabitat'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='master_habitat',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mb.masterhabitat'),
        ),
        migrations.AddField(
            model_name='habitatrelation',
            name='modified_by',
            field=django_userforeignkey.models.fields.UserForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='modifiedby_habitatrelation', to=settings.AUTH_USER_MODEL, verbose_name='The user that is automatically assigned'),
        ),
        migrations.AddField(
            model_name='habitatrelation',
            name='source_habitat',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mb.sourcehabitat'),
        ),
        migrations.AddField(
            model_name='event',
            name='source_habitat',
