...
$(document).ready(function () {
  ...
  $('table').on(
    'click',
    'td.source-attribute-name .editable',
    handleEditableClick
  );
  $("button[id^='matchButton_']").click(handleMatchButtonClick);
  $('table').on(
    'keypress',
    'td.source-attribute-name input.edit-input',
    handleEnterKeyPress
  );
  ...
  function handleEditButtonClick(event) {
    ...
    var $editableSpan = $(this)
      .closest('tr')
      .find('td.source-attribute-name .editable');
      ...
      success: function (data) {
        if (data.match) {
          ...
          var $dropdown = $(
            ...
            .closest('tr')
            .find("select[name='master_attribute']");
  ...
  function handleMatchButtonClick() {
    var sourceAttributeId = $(this).attr('id').split('_')[1];
    var selectedMasterAttributeId = $(this)
      .closest('tr')
      .find("select[name='master_attribute']")
      .val();
